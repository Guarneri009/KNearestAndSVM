...
int main_HOG_SVM(int argc, char** argv)
{
    ...
    //sample_neg(full_neg_lst, neg_lst, Size(28, 28));
    labels.insert(labels.end(), neg_lst.size(), -1);
    CV_Assert(old < labels.size());

    compute_hog(pos_lst, gradient_lst, Size(96, 160));
    compute_hog(neg_lst, gradient_lst, Size(96, 160));
    //compute_hog(pos_lst, gradient_lst, Size(20, 20));
    //compute_hog(neg_lst, gradient_lst, Size(20, 20));
